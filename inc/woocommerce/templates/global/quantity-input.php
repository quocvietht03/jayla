...
if ( $max_value && $min_value === $max_value ) {
	...
	<div class="quantity theme-extends-woo-custom-quantity">
		<!-- <label class="screen-reader-text" for="<?php echo esc_attr( $input_id ); ?>"><?php esc_html_e( 'Quantity', 'jayla' ); ?></label> -->
		...
		<input
			...
			title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'jayla' ) ?>"
			size="4"
